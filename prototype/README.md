...
**Finding #5 (first tester, 2026-07-02, on bay.html):** the ride was hard to read — "the wave might need more visual cues." Fixes, all diegetic (still no HUD or meters): contour bands parallel to the lip so the face reads as a slope; a lit "pocket" zone just ahead of the curl so the right place to be is visibly the bright place; foam fingers reaching from the curl plus screen shake and rising ocean roar when you're about to be caught; spray feathering off the lip so the top edge is unmistakable; a wake that thickens with speed; the incoming wave now stands up and feathers white in the catch window with the hint switching to "NOW — E"; and a one-time five-word tutorial on first catch: "Stay ahead of the foam." Design lesson: every game-state variable a player must manage needs at least one *ambient* visual voice — position had none, threat had none, timing had none. The fix is never a meter; it's making the world itself express the state.
